(defproject elephantdb "0.4.0"
  ...
  :dependencies [[elephantdb/elephantdb-thrift "0.4.0"]
                 [elephantdb/elephantdb-core "0.4.0"]
                 [elephantdb/elephantdb-bdb "0.4.0"]
                 [elephantdb/elephantdb-leveldb "0.4.0"]
                 [elephantdb/elephantdb-server "0.4.0"]
                 [elephantdb/elephantdb-cascading "0.4.0"]]
