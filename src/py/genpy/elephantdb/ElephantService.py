...
class Processor(Iface, TProcessor):
  ...
  def process_get(self, seqid, iprot, oprot):
    ...
    except DomainNotLoadedException, ex:
      result.ex = ex
...
class get_result:
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'ex', (DomainNotLoadedException, DomainNotLoadedException.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 0:
        ...
        if ftype == TType.STRUCT:
          self.ex = DomainNotLoadedException()
          self.ex.read(iprot)
        else:
          iprot.skip(ftype)
      else:
