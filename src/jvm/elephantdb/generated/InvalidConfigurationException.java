...
public class InvalidConfigurationException extends Exception implements org.apache.thrift7.TBase<InvalidConfigurationException, InvalidConfigurationException._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift7.protocol.TStruct STRUCT_DESC = new org.apache.thrift7.protocol.TStruct("InvalidConfigurationException");

  private static final org.apache.thrift7.protocol.TField MISMATCHED_DOMAINS_FIELD_DESC = new org.apache.thrift7.protocol.TField("mismatched_domains", org.apache.thrift7.protocol.TType.LIST, (short)1);
  private static final org.apache.thrift7.protocol.TField PORT_CHANGED_FIELD_DESC = new org.apache.thrift7.protocol.TField("port_changed", org.apache.thrift7.protocol.TType.BOOL, (short)2);
  private static final org.apache.thrift7.protocol.TField HOSTS_CHANGED_FIELD_DESC = new org.apache.thrift7.protocol.TField("hosts_changed", org.apache.thrift7.protocol.TType.BOOL, (short)3);
  ...
  static {
    ...
    tmpMap.put(_Fields.MISMATCHED_DOMAINS, new org.apache.thrift7.meta_data.FieldMetaData("mismatched_domains", org.apache.thrift7.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift7.meta_data.ListMetaData(org.apache.thrift7.protocol.TType.LIST, 
            new org.apache.thrift7.meta_data.FieldValueMetaData(org.apache.thrift7.protocol.TType.STRING))));
    tmpMap.put(_Fields.PORT_CHANGED, new org.apache.thrift7.meta_data.FieldMetaData("port_changed", org.apache.thrift7.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift7.meta_data.FieldValueMetaData(org.apache.thrift7.protocol.TType.BOOL)));
    tmpMap.put(_Fields.HOSTS_CHANGED, new org.apache.thrift7.meta_data.FieldMetaData("hosts_changed", org.apache.thrift7.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift7.meta_data.FieldValueMetaData(org.apache.thrift7.protocol.TType.BOOL)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift7.meta_data.FieldMetaData.addStructMetaDataMap(InvalidConfigurationException.class, metaDataMap);
  }
  ...
  public int compareTo(InvalidConfigurationException other) {
    ...
    if (is_set_mismatched_domains()) {
      lastComparison = org.apache.thrift7.TBaseHelper.compareTo(this.mismatched_domains, typedOther.mismatched_domains);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (is_set_port_changed()) {
      lastComparison = org.apache.thrift7.TBaseHelper.compareTo(this.port_changed, typedOther.port_changed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (is_set_hosts_changed()) {
      lastComparison = org.apache.thrift7.TBaseHelper.compareTo(this.hosts_changed, typedOther.hosts_changed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      switch (field.id) {
        case 1: // MISMATCHED_DOMAINS
          if (field.type == org.apache.thrift7.protocol.TType.LIST) {
            {
              org.apache.thrift7.protocol.TList _list9 = iprot.readListBegin();
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.mismatched_domains != null) {
      ...
      {
        oprot.writeListBegin(new org.apache.thrift7.protocol.TList(org.apache.thrift7.protocol.TType.STRING, this.mismatched_domains.size()));
  ...
  public void validate() throws org.apache.thrift7.TException {
    ...
    if (!is_set_mismatched_domains()) {
      throw new org.apache.thrift7.protocol.TProtocolException("Required field 'mismatched_domains' is unset! Struct:" + toString());
    }

    if (!is_set_port_changed()) {
      throw new org.apache.thrift7.protocol.TProtocolException("Required field 'port_changed' is unset! Struct:" + toString());
    }

    if (!is_set_hosts_changed()) {
      throw new org.apache.thrift7.protocol.TProtocolException("Required field 'hosts_changed' is unset! Struct:" + toString());
    }
