...
public class ElephantDB {
  ...
  public interface Iface {
    ...
    public Value directGet(String domain, byte[] key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException;

    public Value directGetString(String domain, String key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException;

    public Value directGetInt(String domain, int key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException;

    public Value directGetLong(String domain, long key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException;
  ...
  public interface AsyncIface {
    ...
    public void directGetString(String domain, String key, AsyncMethodCallback<AsyncClient.directGetString_call> resultHandler) throws TException;

    public void directGetInt(String domain, int key, AsyncMethodCallback<AsyncClient.directGetInt_call> resultHandler) throws TException;

    public void directGetLong(String domain, long key, AsyncMethodCallback<AsyncClient.directGetLong_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public Value recv_directGet() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
    ...
    public Value directGetString(String domain, String key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      send_directGetString(domain, key);
      return recv_directGetString();
    }

    public void send_directGetString(String domain, String key) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("directGetString", TMessageType.CALL, ++seqid_));
      directGetString_args args = new directGetString_args();
      args.set_domain(domain);
      args.set_key(key);
      args.write(oprot_);
      oprot_.writeMessageEnd();
    ...
    public Value recv_directGetString() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "directGetString failed: out of sequence response");
      }
      directGetString_result result = new directGetString_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.is_set_success()) {
        return result.success;
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "directGetString failed: unknown result");
    }

    public Value directGetInt(String domain, int key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      send_directGetInt(domain, key);
      return recv_directGetInt();
    }

    public void send_directGetInt(String domain, int key) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("directGetInt", TMessageType.CALL, ++seqid_));
      directGetInt_args args = new directGetInt_args();
      args.set_domain(domain);
      args.set_key(key);
      args.write(oprot_);
      oprot_.writeMessageEnd();
    ...
    public Value recv_directGetInt() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "directGetInt failed: out of sequence response");
      }
      directGetInt_result result = new directGetInt_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.is_set_success()) {
        return result.success;
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "directGetInt failed: unknown result");
    }

    public Value directGetLong(String domain, long key) throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      send_directGetLong(domain, key);
      return recv_directGetLong();
    }

    public void send_directGetLong(String domain, long key) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("directGetLong", TMessageType.CALL, ++seqid_));
      directGetLong_args args = new directGetLong_args();
      args.set_domain(domain);
      args.set_key(key);
      args.write(oprot_);
      oprot_.writeMessageEnd();
    ...
    public Value recv_directGetLong() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "directGetLong failed: out of sequence response");
      }
      directGetLong_result result = new directGetLong_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.is_set_success()) {
        return result.success;
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "directGetLong failed: unknown result");
    }
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public static class directGet_call extends TAsyncMethodCall {
      ...
      public Value getResult() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void directGetString(String domain, String key, AsyncMethodCallback<directGetString_call> resultHandler) throws TException {
      checkReady();
      directGetString_call method_call = new directGetString_call(domain, key, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class directGetString_call extends TAsyncMethodCall {
      private String domain;
      private String key;
      public directGetString_call(String domain, String key, AsyncMethodCallback<directGetString_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.domain = domain;
        this.key = key;
      }
      ...
      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("directGetString", TMessageType.CALL, 0));
        directGetString_args args = new directGetString_args();
        args.set_domain(domain);
        args.set_key(key);
        args.write(prot);
      ...
      public Value getResult() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_directGetString();
      }
    }

    public void directGetInt(String domain, int key, AsyncMethodCallback<directGetInt_call> resultHandler) throws TException {
      checkReady();
      directGetInt_call method_call = new directGetInt_call(domain, key, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class directGetInt_call extends TAsyncMethodCall {
      private String domain;
      private int key;
      public directGetInt_call(String domain, int key, AsyncMethodCallback<directGetInt_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.domain = domain;
        this.key = key;
      }
      ...
      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("directGetInt", TMessageType.CALL, 0));
        directGetInt_args args = new directGetInt_args();
        args.set_domain(domain);
        args.set_key(key);
        args.write(prot);
      ...
      public Value getResult() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_directGetInt();
      }
    }

    public void directGetLong(String domain, long key, AsyncMethodCallback<directGetLong_call> resultHandler) throws TException {
      checkReady();
      directGetLong_call method_call = new directGetLong_call(domain, key, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class directGetLong_call extends TAsyncMethodCall {
      private String domain;
      private long key;
      public directGetLong_call(String domain, long key, AsyncMethodCallback<directGetLong_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.domain = domain;
        this.key = key;
      }
      ...
      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("directGetLong", TMessageType.CALL, 0));
        directGetLong_args args = new directGetLong_args();
        args.set_domain(domain);
        args.set_key(key);
        args.write(prot);
      ...
      public Value getResult() throws DomainNotFoundException, HostsDownException, DomainNotLoadedException, WrongHostException, TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_directGetLong();
      }
    }
  ...
  public static class Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("directGetString", new directGetString());
      processMap_.put("directGetInt", new directGetInt());
      processMap_.put("directGetLong", new directGetLong());
    ...
    private class directGetString implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        directGetString_args args = new directGetString_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("directGetString", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        directGetString_result result = new directGetString_result();
        try {
          result.success = iface_.directGetString(args.domain, args.key);
        } catch (DomainNotFoundException dnfe) {
          result.dnfe = dnfe;
        } catch (HostsDownException hde) {
          result.hde = hde;
          ...
          LOGGER.error("Internal error processing directGetString", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing directGetString");
          oprot.writeMessageBegin(new TMessage("directGetString", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
        ...
        oprot.writeMessageBegin(new TMessage("directGetString", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
    ...
    private class directGetInt implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        directGetInt_args args = new directGetInt_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("directGetInt", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        directGetInt_result result = new directGetInt_result();
        try {
          result.success = iface_.directGetInt(args.domain, args.key);
        } catch (DomainNotFoundException dnfe) {
          result.dnfe = dnfe;
        } catch (HostsDownException hde) {
          result.hde = hde;
          ...
          LOGGER.error("Internal error processing directGetInt", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing directGetInt");
          oprot.writeMessageBegin(new TMessage("directGetInt", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
        ...
        oprot.writeMessageBegin(new TMessage("directGetInt", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
    ...
    private class directGetLong implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        directGetLong_args args = new directGetLong_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("directGetLong", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        directGetLong_result result = new directGetLong_result();
        try {
          result.success = iface_.directGetLong(args.domain, args.key);
        } catch (DomainNotFoundException dnfe) {
          result.dnfe = dnfe;
        } catch (HostsDownException hde) {
          result.hde = hde;
          ...
          LOGGER.error("Internal error processing directGetLong", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing directGetLong");
          oprot.writeMessageBegin(new TMessage("directGetLong", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
        ...
        oprot.writeMessageBegin(new TMessage("directGetLong", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
  ...
  public static class directGet_result implements TBase<directGet_result, directGet_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final TField HDE_FIELD_DESC = new TField("hde", TType.STRUCT, (short)2);
    private static final TField DNLE_FIELD_DESC = new TField("dnle", TType.STRUCT, (short)3);
    private static final TField WHE_FIELD_DESC = new TField("whe", TType.STRUCT, (short)4);
  ...
  public static class directGetString_args implements TBase<directGetString_args, directGetString_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetString_args");
    ...
    static {
      ...
      tmpMap.put(_Fields.KEY, new FieldMetaData("key", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetString_args.class, metaDataMap);
    }

    public directGetString_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetString_args(directGetString_args other) {
      if (other.is_set_domain()) {
        this.domain = other.domain;
      }
      if (other.is_set_key()) {
    ...
    public directGetString_args deepCopy() {
      return new directGetString_args(this);
    }

    @Deprecated
    public directGetString_args clone() {
      return new directGetString_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetString_args)
        return this.equals((directGetString_args)that);
      return false;
    }

    public boolean equals(directGetString_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetString_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetString_args typedOther = (directGetString_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetString_args(");
      boolean first = true;
  ...
  public static class directGetString_result implements TBase<directGetString_result, directGetString_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetString_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.WHE, new FieldMetaData("whe", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetString_result.class, metaDataMap);
    }

    public directGetString_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetString_result(directGetString_result other) {
      if (other.is_set_success()) {
        this.success = new Value(other.success);
      }
      if (other.is_set_dnfe()) {
    ...
    public directGetString_result deepCopy() {
      return new directGetString_result(this);
    }

    @Deprecated
    public directGetString_result clone() {
      return new directGetString_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetString_result)
        return this.equals((directGetString_result)that);
      return false;
    }

    public boolean equals(directGetString_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetString_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetString_result typedOther = (directGetString_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetString_result(");
      boolean first = true;
  ...
  public static class directGetInt_args implements TBase<directGetInt_args, directGetInt_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetInt_args");
    ...
    static {
      ...
      tmpMap.put(_Fields.KEY, new FieldMetaData("key", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.I32)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetInt_args.class, metaDataMap);
    }

    public directGetInt_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetInt_args(directGetInt_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      if (other.is_set_domain()) {
        this.domain = other.domain;
    ...
    public directGetInt_args deepCopy() {
      return new directGetInt_args(this);
    }

    @Deprecated
    public directGetInt_args clone() {
      return new directGetInt_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetInt_args)
        return this.equals((directGetInt_args)that);
      return false;
    }

    public boolean equals(directGetInt_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetInt_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetInt_args typedOther = (directGetInt_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetInt_args(");
      boolean first = true;
  ...
  public static class directGetInt_result implements TBase<directGetInt_result, directGetInt_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetInt_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.WHE, new FieldMetaData("whe", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetInt_result.class, metaDataMap);
    }

    public directGetInt_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetInt_result(directGetInt_result other) {
      if (other.is_set_success()) {
        this.success = new Value(other.success);
      }
      if (other.is_set_dnfe()) {
    ...
    public directGetInt_result deepCopy() {
      return new directGetInt_result(this);
    }

    @Deprecated
    public directGetInt_result clone() {
      return new directGetInt_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetInt_result)
        return this.equals((directGetInt_result)that);
      return false;
    }

    public boolean equals(directGetInt_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetInt_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetInt_result typedOther = (directGetInt_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetInt_result(");
      boolean first = true;
  ...
  public static class directGetLong_args implements TBase<directGetLong_args, directGetLong_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetLong_args");
    ...
    static {
      ...
      tmpMap.put(_Fields.KEY, new FieldMetaData("key", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.I64)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetLong_args.class, metaDataMap);
    }

    public directGetLong_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetLong_args(directGetLong_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      if (other.is_set_domain()) {
        this.domain = other.domain;
    ...
    public directGetLong_args deepCopy() {
      return new directGetLong_args(this);
    }

    @Deprecated
    public directGetLong_args clone() {
      return new directGetLong_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetLong_args)
        return this.equals((directGetLong_args)that);
      return false;
    }

    public boolean equals(directGetLong_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetLong_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetLong_args typedOther = (directGetLong_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetLong_args(");
      boolean first = true;
  ...
  public static class directGetLong_result implements TBase<directGetLong_result, directGetLong_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("directGetLong_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.WHE, new FieldMetaData("whe", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(directGetLong_result.class, metaDataMap);
    }

    public directGetLong_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public directGetLong_result(directGetLong_result other) {
      if (other.is_set_success()) {
        this.success = new Value(other.success);
      }
      if (other.is_set_dnfe()) {
    ...
    public directGetLong_result deepCopy() {
      return new directGetLong_result(this);
    }

    @Deprecated
    public directGetLong_result clone() {
      return new directGetLong_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof directGetLong_result)
        return this.equals((directGetLong_result)that);
      return false;
    }

    public boolean equals(directGetLong_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(directGetLong_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      directGetLong_result typedOther = (directGetLong_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("directGetLong_result(");
      boolean first = true;
