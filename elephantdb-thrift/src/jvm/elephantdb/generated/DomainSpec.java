...
public class DomainSpec implements org.apache.thrift.TBase<DomainSpec, DomainSpec._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(DomainSpec other) {
    ...
    lastComparison = Boolean.valueOf(is_set_shard_scheme()).compareTo(typedOther.is_set_shard_scheme());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_shard_scheme()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.shard_scheme, typedOther.shard_scheme);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
